...
import com.techuva.iot.ngt.api_interface.CurrentAgriDataInterface;
import com.techuva.iot.ngt.api_interface.HistoryTableGetData;
import com.techuva.iot.ngt.app.Constants;
import com.techuva.iot.ngt.listener.SimpleGestureListener;
...
public class HistoryDataAgriTableActivity extends AppCompatActivity {
    ...
    private void serviceCallforChannelData() {
        ...
        Call<JsonElement> call = service.getHistoryForAgriasJson(UserId, authorityKey, new HistoryDataAllChannelPostParamter(deviceId, fromDateforCall, toDateforCall, pagePerCount, String.valueOf(pageNumber)));
...
/*      params = new TableLayout.LayoutParams(30, 40);
    ...
    private void init() {
        context = HistoryDataAgriTableActivity.this;
