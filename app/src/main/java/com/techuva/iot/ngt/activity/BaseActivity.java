...
import com.techuva.iot.ngt.adapter.NavDrawerListAdapter;
import com.techuva.iot.ngt.app.Constants;
import com.techuva.iot.ngt.model.NavDrawerItem;
...
*/
    ...
    private void generateiconandstringfordrawer() {
        ...
        // Logout
        navDrawerItems.add(new NavDrawerItem(nav_item_titlenames[3], R.drawable.logout));
    }
