...
import com.techuva.iot.ngt.adapter.AccountListRcvAdapter;
import com.techuva.iot.ngt.api_interface.AccountDetailsInterface;
import com.techuva.iot.ngt.app.Constants;
import com.techuva.iot.ngt.model.AccountListResultObject;
import com.techuva.iot.ngt.model.AccountsListMainObject;
...
public class UserAccountsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        exitToast = Toast.makeText(getApplicationContext(), R.string.exit_toast, Toast.LENGTH_SHORT); serviceCall();
        setTypeface();
        onClickEvent();
    ...
    private void onClickEvent() {
        tv_btn_continue.setOnClickListener(new View.OnClickListener() {
            @Override
