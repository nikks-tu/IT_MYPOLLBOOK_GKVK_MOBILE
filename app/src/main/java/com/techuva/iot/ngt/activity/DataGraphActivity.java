...
import com.techuva.iot.ngt.adapter.HexagonChannelRcvAdapter;
import com.techuva.iot.ngt.api_interface.GetDataForGraph;
import com.techuva.iot.ngt.api_interface.HistoryDataInterface;
import com.techuva.iot.ngt.app.Constants;
import com.techuva.iot.ngt.listener.RecyclerItemClickListener;
import com.techuva.iot.ngt.model.ChannelUnitMeasureDO;
import com.techuva.iot.ngt.model.GraphDataPostParamter;
...
import com.techuva.iot.ngt.views.AppDatabase;
import com.techuva.iot.ngt.views.ChartHelper;
...
public class DataGraphActivity extends AppCompatActivity {
                    ...
                    if(!jsonObject.isJsonNull())
                    {
                        ...
                        if(jObj.get("ErrorCode").getAsString().equals("1"))
                        {
                         ...
                         /*   ll_data_not_found.setVisibility(View.GONE);
                            ...
                            //
                            // xAxis.setValueFormatter(new MyXValueFormatter(listValueTime));
                           /* xAxis.setValueFormatter(new IndexAxisValueFormatter()
                            {
                                @Override
                                public String getFormattedValue(float value, AxisBase axis) {
                                    return String.valueOf(listValueTime.get((int)value));
                                }
                            });*/
                            //xAxis.setAxisMaxValue(maxXRange);
    ...
    private void dataResponse(HistoryDataResultObject result) {
        ...
        measurementUnit = getUnitOfChannel(Integer.parseInt(channelNumber));
        //Toast.makeText(context, channelNumber, Toast.LENGTH_SHORT).show();
        tv_unit_measure.setText(measurementUnit);
