...
import com.techuva.iot.ngt.api_interface.ForwarningDataInterface;
import com.techuva.iot.ngt.api_interface.LeafwetnessDataInterface;
...
public class ForewarninActivity extends AppCompatActivity {
    ...
    String secondChannelIdforLeafWetness;
    int UserId;
    String authorityKey = "";
    String grantType = "";
    Toolbar toolbar;
    String inventoryID="";
    LinearLayout ll_main_values, ll_fw_item_1, ll_fw_item_2, ll_fw_item_3, ll_leafwetness, ll_leafwetness_1;
    CardView cv_fw_item_1, cv_fw_item_2, cv_fw_item_3, cv_item_leafwetness, cv_item_leafwetness_1;
    TextView tv_channel_data_one, tv_channel_name_one, tv_channel_data_two, tv_channel_name_two;
    TextView tv_channel_data_three, tv_channel_name_three, tv_channel_data_lw, tv_channel_name_lw, tv_channel_data_lw_1, tv_channel_name_lw_1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceCallforLeafwetnessSecondChannel();
    ...
    private void init() {
        ...
        ll_leafwetness_1 = findViewById(R.id.ll_leafwetness_1);
        ...
        cv_item_leafwetness_1 = findViewById(R.id.cv_item_leafwetness_1);
        ...
        tv_channel_data_lw_1 = findViewById(R.id.tv_channel_data_lw_1);
        tv_channel_name_lw = findViewById(R.id.tv_channel_name_lw);
        tv_channel_name_lw_1 = findViewById(R.id.tv_channel_name_lw_1);
        ...
        secondChannelIdforLeafWetness = "9";
    ...
    private void serviceCallforLeafwetnessSecondChannel() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(Constants.BASE_URL_TOKEN)
                .addConverterFactory(ScalarsConverterFactory.create())
                .addConverterFactory(GsonConverterFactory.create())
        ...
        LeafwetnessDataInterface service = retrofit.create(LeafwetnessDataInterface.class);
        Call<JsonElement> call = service.getStringScalarWithSession(UserId, authorityKey, new LeafWetnessPostParameters(secondChannelIdforLeafWetness, deviceId, toDate));
        call.enqueue(new Callback<JsonElement>() {
            ...
            public void onResponse(Call<JsonElement> call, Response<JsonElement> response) {
                ...
                if (response.code() == 401) {
                    ...
                    if (infoObject.get("ErrorCode").getAsInt()==0) {
                        tv_nodata.setVisibility(View.GONE);
                        JsonObject result = jsonObject.get("result").getAsJsonObject();
                        setValuesLeafWetnessSecondChannel(result);
                    } else {
                        cv_item_leafwetness_1.setVisibility(View.INVISIBLE);
                    }
    ...
    private void setValuesLeafWetnessSecondChannel(JsonObject result) {
          /* @SerializedName("CHANNEL_NUMBER")
    @Expose
    private Integer cHANNELNUMBER;
    @SerializedName("CHANNEL_ICON")
    ...
    private String cHANNELLABEL;
    @SerializedName("UNIT_OF_MEASURE")*/
        cv_item_leafwetness_1.setVisibility(View.VISIBLE);
        tv_channel_name_lw_1.setText(result.get("CHANNEL_LABEL").getAsString());
        if (result.get("Value").getAsString().equals("")) {
            tv_channel_data_lw_1.setText("-NA-");
        } else {
            String value = result.get("Value").getAsString();
            tv_channel_data_lw_1.setText(value);
        }
