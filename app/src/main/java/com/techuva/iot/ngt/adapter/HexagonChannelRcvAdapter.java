...
import com.techuva.iot.ngt.holders.HexagonChannelRCVHolder;
...
{// Recyclerview will extend to
    ...
    public void onBindViewHolder(HexagonChannelRCVHolder holder, int position) {
        ...
        if(selectedPosition==position){
            holder.ll_main.setBackground(context.getResources().getDrawable(R.drawable.hexagon_selected));
        }
        else
        {
            holder.ll_main.setBackground(context.getResources().getDrawable(R.drawable.hexagon));
        }
